...
let
  ...
  llama-cpp-grpc = (llama-cpp.overrideAttrs (final: prev: {
    ...
    src = fetchFromGitHub {
      owner = "ggerganov";
      repo = "llama.cpp";
      rev = "87e397d00bdcedd5cbf6dfda06a7b0f302462728";
      hash = "sha256-HGjPJ9Ig9NJlJha7PewYJZwR0xDKKXeGVBHnkDTzHM8=";
      fetchSubmodules = true;
    };
  ...
  whisper-cpp = effectiveStdenv.mkDerivation {
    ...
    src = fetchFromGitHub {
      owner = "ggerganov";
      repo = "whisper.cpp";
      rev = "f68298ce06ca3edd6e6f3f21c3d0bb5f073942c3";
      hash = "sha256-PuNzy3h5LwPoQY4B2ts3L5l7xDAIFveNQOmuAJowgcM=";
    };
  ...
  src = fetchFromGitHub {
    ...
    repo = "LocalAI";
    rev = "v${version}";
    hash = "sha256-KUjIwuedqYWHMo4rK7rGQDOzdm87awpQi8+5R8W03IY=";
  };
